...
public class FallDetector : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //- GameObject.Find finds a gameobject with a certain name (in this case anyway, other versions exist)
    ...
    /// </summary>
    /// <param name="other">The object colliding with the fall detector. See remark at the start of the class about collision layers. 
    /// We could also let every layer detect collisions, and then filter on some aspect of the colliding object (tag, gameobject name, ...) 
    /// and only take action if it was a bowling pin. Of course this would be less efficient, because more collisions would be processed.</param>
